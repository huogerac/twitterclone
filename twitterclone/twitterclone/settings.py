...
ALLOWED_HOSTS = config(
    "ALLOWED_HOSTS",
    default="twitterclone.fly.dev",
    cast=Csv(),
)

CSRF_TRUSTED_ORIGINS = config(
    "CSRF_TRUSTED_ORIGINS",
    default="https://twitterclone.fly.dev",
    cast=Csv(),
)
...
ROOT_URLCONF = "twitterclone.twitterclone.urls"
...
WSGI_APPLICATION = "twitterclone.twitterclone.wsgi.application"
...
#             'filename': os.getenv('DJANGO_LOG_FILE', './twitterclone.log'),
#             'formatter': 'simple'
#         },
#     },
#     'loggers': {
